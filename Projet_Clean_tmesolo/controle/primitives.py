...
class TournerAngle(AlgoBase):
    ...
    """
    def __init__(self, traducteur, angle_rad, vitesse_roues, sens="droite"):
        super().__init__(traducteur)
    ...
    def step(self):
        if self.stop():
            ...
            self.trad.change_couleur((r.randint(0, 255), r.randint(0, 255), r.randint(0, 255)))
            print('tourner stop')
    ...
    def stop(self):
        print(abs(self.trad.get_angle_parcouru()), self.angle_rad)
