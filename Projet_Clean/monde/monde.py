...
class Monde:
    ...
    '''
        ...
        self.liste_obstacles = []
        mid_x = cfg.LONGUEUR_MONDE / 2 

    # Ajouter les 3 obstacles (x, y)
    # 1. milieu
        self.ajouter_obstacle(mid_x * cfg.SCALE, 0.5 * cfg.SCALE)
    
    # 2. centre
        self.ajouter_obstacle(mid_x * cfg.SCALE, 1.5 * cfg.SCALE)
    
    # 3.  milieu
        self.ajouter_obstacle(mid_x * cfg.SCALE, 2.5 * cfg.SCALE)
