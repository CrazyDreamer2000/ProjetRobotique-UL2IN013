...
• Implémenter la classe Boucle : 

- Implémenter la classe Boucle avec deux paramètres : nom de la stratégie à appliquer et nombre de répétitions.
...
• Implémenter Stratégies conditionnelles (par exemple la gestion des collisions) :

- Selon le résultat d’une fonction (ex : test de collision), exécuter soit la stratégie 1, soit la stratégie 2.
- Permet une gestion des comportements selon les situations rencontrées.
...
• Supprimer et remplacer d’éléments pour uniformisation :
