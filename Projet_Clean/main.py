...
robot = Robot(cfg.RAYON_ROUE, cfg.ECARTEMENT_ROUES, parseArgs.orientation, cfg.LONGUEUR_MONDE*0.9, cfg.LARGEUR_MONDE/2)
robot2 = Robot(cfg.RAYON_ROUE, cfg.ECARTEMENT_ROUES, parseArgs.orientation, cfg.LONGUEUR_MONDE*0.1 , cfg.LARGEUR_MONDE/2 )
